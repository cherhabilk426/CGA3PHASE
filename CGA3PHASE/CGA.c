...
//====================== PARK ==========================================================================
void PARK( real_T Va , real_T Vb , real_T Vc , real_T Angle ,real_T* Vd, real_T* Vq)
{   
   real_T K0 = sqrt(2.0/3) ; // Constant de PARK
   *Vd =  K0 * ( Va * cos( Angle ) + Vb * cos( Angle - 2 * PI / 3 ) + Vc * cos( Angle + 2 * PI / 3 ) ) ; 
   *Vq = -K0 * ( Va * sin( Angle ) + Vb * sin( Angle - 2 * PI / 3 ) + Vc * sin( Angle + 2 * PI / 3 ) ) ;
}
//=======================================================================================================

//====================== PARK_INV =======================================================================
void PARK_INV( real_T Vd , real_T Vq , real_T Angle ,real_T* Va, real_T* Vb , real_T* Vc )
{   
    *Va = Vd   * cos( Angle )              - Vq   * sin( Angle ) ;                // Va 
    *Vb = Vd   * cos( Angle - 2 * PI / 3 ) - Vq   * sin( Angle - 2 * PI / 3 ) ;   // Vb   
    *Vc = Vd   * cos( Angle + 2 * PI / 3 ) - Vq   * sin( Angle + 2 * PI / 3 ) ;   // Vc   
}
//=======================================================================================================
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
 ...
 //==================================================================================   
    ...
    PARK( Iabc1[0] , Iabc1[1] , Iabc1[2] , Theta_s ,&Id, &Iq) ;
...
//=========================================================================================== 
 ...
 //=================================================================================
 PARK_INV( Is_d_ref , Is_q_ref , Theta_s ,&Iabc[0], &Iabc[1] , &Iabc[2] );
