...
#define h  1e-6
real_T t , def_1 , def_2 , def_3,Sin_a,Sin_b,Sin_c,tri_1,f_tri; 
/* Error handling
 * --------------
 *
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    //entree
    const real_T *Sin_abc      = (const real_T*)    ssGetInputPortSignal(S,0);  // Vs_abc
   // const real_T *Ws1          = (const real_T*)    ssGetInputPortSignal(S,1);  // Ws
    ...
    real_T       *tri_0    = ssGetOutputPortSignal(S,3);
    ...
    //Sin_a = 0.8 *5 * sin( Ws1[0] * t );
    //Sin_b = 0.8 *5 * sin( Ws1[0] * t - 2 * PI / 3 );
    //Sin_c = 0.8 *5 * sin( Ws1[0] * t + 2 * PI / 3 );
    
    sin_1[0] = Sin_a ;
    sin_2[0] = Sin_b ;
    sin_3[0] = Sin_c ;
       
    tri_1    = 500 * (-2.0) * asin( cos( 2 * PI * f_tri * t ) ) / PI ;
    tri_0[0] = tri_1 ;
